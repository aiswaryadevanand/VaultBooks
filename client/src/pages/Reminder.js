...
//     } catch {
//       toast.error('Failed to fetch reminders', { icon: <CheckCircle color="red" /> });
//     }
//   };
...
//                       <>
//                         <button onClick={() => handleEdit(reminder)} className="text-blue-600 hover:text-blue-800">
...
//     try {
//       await deleteReminder(confirm.id, walletId);
...
//       {/* 🔄 Blur overlay when toast is active */}
//       {isToastVisible && (
//         <div className="fixed inset-0 bg-black/10 backdrop-blur-sm z-40 pointer-events-none transition-opacity" />
//       )}
...
//                         <AlarmClock className="w-4 h-4" /> Overdue
//                       </p>
//                     ) : (
//                       <p className="text-sm text-green-600 flex items-center gap-1">
//                         <CheckCircle className="w-4 h-4" /> Upcoming
//                       </p>
//                     )}
...
//                             <button
//                               onClick={() =>
//                                 setConfirm({ show: true, id: reminder._id })
//                               }
